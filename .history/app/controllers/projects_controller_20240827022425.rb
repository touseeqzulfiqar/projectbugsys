class ProjectsController < ApplicationController
  ...
  respond_to do |format|
    if @project.save
      UserMailer(new_user: current_user, project: @project).deliver_now
  ...
  def project_params
    params.require(:project).permit(:name, :description, user_ids: [], users_attributes: [:id, :email, :name, :role, :password, :password_confirmation, :_destroy])
  end
end
