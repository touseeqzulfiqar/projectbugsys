class ProjectsController < ApplicationController
  ...
  def create
    ...
    if @project.save
      ...
      # If needed, assign QAs in a similar manner
      # @project.users << User.where(id: params[:project][:qa_ids]) if params[:project][:qa_ids].present?

      # Add the current user to the project if not already added
  ...
  def update
    if @project.update(project_params)
      # Clear previous associations and add the new ones
      @project.users.clear
