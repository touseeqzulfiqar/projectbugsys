document.addEventListener("DOMContentLoaded", function () {
  ...
  function createRoleFields() {
    ...
    newField.querySelector(".user-select").addEventListener("change", updateUserOptions);
  }

  // Function to get user options excluding selected ones
  function getUserOptions(role) {
    if (typeof qaUsers === "undefined" || typeof developerUsers === "undefined") {
  ...
  function updateUserOptions() {
    document.querySelectorAll(".role-field").forEach((field) => {
      ...
      const userSelect = field.querySelector(".user-select[data-role='" + role + "']");
