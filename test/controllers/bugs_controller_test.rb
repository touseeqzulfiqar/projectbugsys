...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference("Bug.count") do
      post bugs_url, params: { bug: { description: @bug.description, project_id: @bug.project_id, status: @bug.status } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { description: @bug.description, project_id: @bug.project_id, status: @bug.status } }
